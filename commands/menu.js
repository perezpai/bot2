export default {
  ...
  async run(sock, msg) {
    const texto = `╭─〔 *PEREZ_BOT* 〕─╮
│
│ 📂 Comandos principales
│  .v    → Guarda localmente (respondiendo a un view-once)
│  .     → Guarda un estado (respondiendo al mensaje reenviado)
│
│ 🔁 Alias de .v: .ver  ..  .ufff  .esta  .jajajaja
│
│ 📌 Uso rápido:
│  - Recuperar un "ver una sola vez": responde ese mensaje con `.v`.
│  - Guardar un estado: reenvía el estado al chat del bot y responde con `.` (punto).
│
